...
1. What is the DOM?
A node-based representation of the webpage which you can change/edit the layout with javascript

2. What is an event?
Is a javascript object thats representational of when "something happens"- interaction, loading, etc.

3. What is an event listener?
A function that "listens" or constantly looks for an event to happen

4. Why would we convert a NodeList into an Array?
To access array functions

5. What is a component?
An abstracted, reusable piece of code that allows you to build "parts" or components of websites
